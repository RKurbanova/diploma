...
- apply template
- create docker infrastructure with postgres
    - monolite for now, but following domain separation
- test db access
- create initial user entity via gorm
- create authorization login (use folders like delivery, usecase, repo??? (Better check ddd guide again))
- create role system in user pkg
- test auth and role systems
- create fill script for test users
- create simple front and try to wire
    - maybe utilize CORS and TLS
